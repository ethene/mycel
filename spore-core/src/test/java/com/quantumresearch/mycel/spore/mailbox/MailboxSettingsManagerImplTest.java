...
import static com.quantumresearch.mycel.spore.mailbox.MailboxSettingsManagerImpl.SETTINGS_KEY_ATTEMPTS;
import static com.quantumresearch.mycel.spore.mailbox.MailboxSettingsManagerImpl.SETTINGS_KEY_LAST_ATTEMPT;
import static com.quantumresearch.mycel.spore.mailbox.MailboxSettingsManagerImpl.SETTINGS_KEY_LAST_SUCCESS;
import static com.quantumresearch.mycel.spore.mailbox.MailboxSettingsManagerImpl.SETTINGS_KEY_ONION;
import static com.quantumresearch.mycel.spore.mailbox.MailboxSettingsManagerImpl.SETTINGS_KEY_SERVER_SUPPORTS;
import static com.quantumresearch.mycel.spore.mailbox.MailboxSettingsManagerImpl.SETTINGS_KEY_TOKEN;
import static com.quantumresearch.mycel.spore.mailbox.MailboxSettingsManagerImpl.SETTINGS_NAMESPACE;
import static com.quantumresearch.mycel.spore.mailbox.MailboxSettingsManagerImpl.SETTINGS_UPLOADS_NAMESPACE;
import static com.quantumresearch.mycel.spore.test.TestUtils.getEvent;
