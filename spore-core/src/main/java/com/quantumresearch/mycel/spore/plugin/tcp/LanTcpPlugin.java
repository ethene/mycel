...
import static com.quantumresearch.mycel.spore.api.keyagreement.KeyAgreementConstants.TRANSPORT_ID_LAN;
import static com.quantumresearch.mycel.spore.api.plugin.LanTcpConstants.DEFAULT_PREF_PLUGIN_ENABLE;
import static com.quantumresearch.mycel.spore.api.plugin.LanTcpConstants.ID;
import static com.quantumresearch.mycel.spore.api.plugin.LanTcpConstants.PREF_IPV6;
import static com.quantumresearch.mycel.spore.api.plugin.LanTcpConstants.PREF_LAN_IP_PORTS;
import static com.quantumresearch.mycel.spore.api.plugin.LanTcpConstants.PROP_IPV6;
import static com.quantumresearch.mycel.spore.api.plugin.LanTcpConstants.PROP_IP_PORTS;
import static com.quantumresearch.mycel.spore.api.plugin.LanTcpConstants.PROP_PORT;
...
import static com.quantumresearch.mycel.spore.util.StringUtils.join;
import static com.quantumresearch.mycel.spore.util.StringUtils.toHexString;
import static com.quantumresearch.mycel.spore.util.StringUtils.utf8IsTooLong;
