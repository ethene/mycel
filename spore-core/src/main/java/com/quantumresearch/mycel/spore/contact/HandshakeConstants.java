...
interface HandshakeConstants {
	...
	String MASTER_KEY_LABEL_0_0 =
			"com.quantumresearch.mycel.spore.handshake/MASTER_KEY";
	...
	String MASTER_KEY_LABEL_0_1 =
			"com.quantumresearch.mycel.spore.handshake/MASTER_KEY_0_1";

	/**
	 * Label for deriving Alice's proof of ownership from the master key.
	 */
	String ALICE_PROOF_LABEL = "com.quantumresearch.mycel.spore.handshake/ALICE_PROOF";

	/**
	 * Label for deriving Bob's proof of ownership from the master key.
	 */
	String BOB_PROOF_LABEL = "com.quantumresearch.mycel.spore.handshake/BOB_PROOF";
