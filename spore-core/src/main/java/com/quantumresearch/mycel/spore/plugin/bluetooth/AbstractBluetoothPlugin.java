...
import com.quantumresearch.mycel.spore.api.Multiset;
...
import com.quantumresearch.mycel.spore.api.keyagreement.event.KeyAgreementListeningEvent;
import com.quantumresearch.mycel.spore.api.keyagreement.event.KeyAgreementStoppedListeningEvent;
...
import com.quantumresearch.mycel.spore.api.properties.event.RemoteTransportPropertiesUpdatedEvent;
...
import static com.quantumresearch.mycel.spore.api.keyagreement.KeyAgreementConstants.TRANSPORT_ID_BLUETOOTH;
import static com.quantumresearch.mycel.spore.api.plugin.BluetoothConstants.DEFAULT_PREF_ADDRESS_IS_REFLECTED;
import static com.quantumresearch.mycel.spore.api.plugin.BluetoothConstants.DEFAULT_PREF_EVER_CONNECTED;
import static com.quantumresearch.mycel.spore.api.plugin.BluetoothConstants.DEFAULT_PREF_PLUGIN_ENABLE;
import static com.quantumresearch.mycel.spore.api.plugin.BluetoothConstants.ID;
import static com.quantumresearch.mycel.spore.api.plugin.BluetoothConstants.PREF_ADDRESS_IS_REFLECTED;
import static com.quantumresearch.mycel.spore.api.plugin.BluetoothConstants.PREF_EVER_CONNECTED;
import static com.quantumresearch.mycel.spore.api.plugin.BluetoothConstants.PROP_ADDRESS;
import static com.quantumresearch.mycel.spore.api.plugin.BluetoothConstants.PROP_UUID;
...
import static com.quantumresearch.mycel.spore.api.properties.TransportPropertyConstants.REFLECTED_PROPERTY_PREFIX;
import static com.quantumresearch.mycel.spore.util.LogUtils.logException;
import static com.quantumresearch.mycel.spore.util.PrivacyUtils.scrubMacAddress;
import static com.quantumresearch.mycel.spore.util.StringUtils.isNullOrEmpty;
import static com.quantumresearch.mycel.spore.util.StringUtils.macToBytes;
import static com.quantumresearch.mycel.spore.util.StringUtils.macToString;
...
abstract class AbstractBluetoothPlugin<S, SS> implements BluetoothPlugin,
	 ...
	 * {@link com.quantumresearch.mycel.spore.api.plugin.Plugin.State#DISABLED}
