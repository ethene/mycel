...
import com.quantumresearch.mycel.spore.test.TestUtils.getPendingContact
import com.quantumresearch.mycel.spore.test.TestUtils.getRandomBytes
...
internal class ContactControllerTest : ControllerTest() {
    ...
    fun testAddPendingContact() {
        val link = "mycel://mycel://adnsyffpsenoc3yzlhr24aegfq2pwan7kkselocill2choov6sbhs"
        val alias = "Alias123"
        val body = """{
            "link": "$link",
            "alias": "$alias"
    ...
    fun testAddPendingContactMissingAlias() {
        val link = "mycel://adnsyffpsenoc3yzlhr24aegfq2pwan7kkselocill2choov6sbhs"
        val body = """{
            "link": "$link"
        }"""
        every { ctx.body() } returns body
    ...
    fun testSetContactAlias() {
        mockkStatic("com.quantumresearch.mycel.app.headless.RouterKt")
