...
import com.quantumresearch.mycel.infrastructure.api.Multiset;
...
import com.quantumresearch.mycel.infrastructure.api.properties.event.RemoteTransportPropertiesUpdatedEvent;
...
import static com.quantumresearch.mycel.infrastructure.api.plugin.BluetoothConstants.DEFAULT_PREF_ADDRESS_IS_REFLECTED;
import static com.quantumresearch.mycel.infrastructure.api.plugin.BluetoothConstants.DEFAULT_PREF_EVER_CONNECTED;
import static com.quantumresearch.mycel.infrastructure.api.plugin.BluetoothConstants.DEFAULT_PREF_PLUGIN_ENABLE;
import static com.quantumresearch.mycel.infrastructure.api.plugin.BluetoothConstants.ID;
import static com.quantumresearch.mycel.infrastructure.api.plugin.BluetoothConstants.PREF_ADDRESS_IS_REFLECTED;
import static com.quantumresearch.mycel.infrastructure.api.plugin.BluetoothConstants.PREF_EVER_CONNECTED;
import static com.quantumresearch.mycel.infrastructure.api.plugin.BluetoothConstants.PROP_ADDRESS;
import static com.quantumresearch.mycel.infrastructure.api.plugin.BluetoothConstants.PROP_UUID;
import static com.quantumresearch.mycel.infrastructure.api.plugin.BluetoothConstants.UUID_BYTES;
...
import static com.quantumresearch.mycel.infrastructure.api.properties.TransportPropertyConstants.REFLECTED_PROPERTY_PREFIX;
import static com.quantumresearch.mycel.infrastructure.util.LogUtils.logException;
import static com.quantumresearch.mycel.infrastructure.util.PrivacyUtils.scrubMacAddress;
import static com.quantumresearch.mycel.infrastructure.util.StringUtils.isNullOrEmpty;
import static com.quantumresearch.mycel.infrastructure.util.StringUtils.macToBytes;
import static com.quantumresearch.mycel.infrastructure.util.StringUtils.macToString;
