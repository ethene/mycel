...
import static com.quantumresearch.mycel.infrastructure.api.plugin.LanTcpConstants.DEFAULT_PREF_PLUGIN_ENABLE;
import static com.quantumresearch.mycel.infrastructure.api.plugin.LanTcpConstants.ID;
import static com.quantumresearch.mycel.infrastructure.api.plugin.LanTcpConstants.PREF_IPV6;
import static com.quantumresearch.mycel.infrastructure.api.plugin.LanTcpConstants.PREF_LAN_IP_PORTS;
import static com.quantumresearch.mycel.infrastructure.api.plugin.LanTcpConstants.PROP_IPV6;
import static com.quantumresearch.mycel.infrastructure.api.plugin.LanTcpConstants.PROP_IP_PORTS;
import static com.quantumresearch.mycel.infrastructure.api.plugin.LanTcpConstants.PROP_PORT;
import static com.quantumresearch.mycel.infrastructure.api.properties.TransportPropertyConstants.MAX_PROPERTY_LENGTH;
...
import static com.quantumresearch.mycel.infrastructure.util.PrivacyUtils.scrubSocketAddress;
import static com.quantumresearch.mycel.infrastructure.util.StringUtils.fromHexString;
import static com.quantumresearch.mycel.infrastructure.util.StringUtils.isNullOrEmpty;
import static com.quantumresearch.mycel.infrastructure.util.StringUtils.join;
import static com.quantumresearch.mycel.infrastructure.util.StringUtils.toHexString;
