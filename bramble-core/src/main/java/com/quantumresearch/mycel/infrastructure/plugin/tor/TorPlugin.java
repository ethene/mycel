...
import com.quantumresearch.mycel.infrastructure.PoliteExecutor;
...
import com.quantumresearch.mycel.infrastructure.api.battery.event.BatteryEvent;
...
import com.quantumresearch.mycel.infrastructure.api.plugin.ConnectionHandler;
import com.quantumresearch.mycel.infrastructure.api.plugin.PluginCallback;
import com.quantumresearch.mycel.infrastructure.api.plugin.PluginException;
import com.quantumresearch.mycel.infrastructure.api.plugin.TorConstants;
...
import com.quantumresearch.mycel.infrastructure.api.rendezvous.RendezvousEndpoint;
...
import static com.quantumresearch.mycel.infrastructure.api.plugin.Plugin.State.DISABLED;
import static com.quantumresearch.mycel.infrastructure.api.plugin.Plugin.State.ENABLING;
import static com.quantumresearch.mycel.infrastructure.api.plugin.Plugin.State.INACTIVE;
import static com.quantumresearch.mycel.infrastructure.api.plugin.Plugin.State.STARTING_STOPPING;
import static com.quantumresearch.mycel.infrastructure.api.plugin.TorConstants.DEFAULT_PREF_PLUGIN_ENABLE;
import static com.quantumresearch.mycel.infrastructure.api.plugin.TorConstants.DEFAULT_PREF_TOR_MOBILE;
import static com.quantumresearch.mycel.infrastructure.api.plugin.TorConstants.DEFAULT_PREF_TOR_NETWORK;
import static com.quantumresearch.mycel.infrastructure.api.plugin.TorConstants.DEFAULT_PREF_TOR_ONLY_WHEN_CHARGING;
import static com.quantumresearch.mycel.infrastructure.api.plugin.TorConstants.HS_PRIVATE_KEY_V3;
import static com.quantumresearch.mycel.infrastructure.api.plugin.TorConstants.ID;
import static com.quantumresearch.mycel.infrastructure.api.plugin.TorConstants.PREF_TOR_MOBILE;
import static com.quantumresearch.mycel.infrastructure.api.plugin.TorConstants.PREF_TOR_NETWORK;
import static com.quantumresearch.mycel.infrastructure.api.plugin.TorConstants.PREF_TOR_NETWORK_AUTOMATIC;
import static com.quantumresearch.mycel.infrastructure.api.plugin.TorConstants.PREF_TOR_NETWORK_WITH_BRIDGES;
import static com.quantumresearch.mycel.infrastructure.api.plugin.TorConstants.PREF_TOR_ONLY_WHEN_CHARGING;
import static com.quantumresearch.mycel.infrastructure.api.plugin.TorConstants.PREF_TOR_PORT;
import static com.quantumresearch.mycel.infrastructure.api.plugin.TorConstants.PROP_ONION_V3;
import static com.quantumresearch.mycel.infrastructure.api.plugin.TorConstants.REASON_BATTERY;
import static com.quantumresearch.mycel.infrastructure.api.plugin.TorConstants.REASON_MOBILE_DATA;
import static com.quantumresearch.mycel.infrastructure.plugin.tor.TorRendezvousCrypto.SEED_BYTES;
...
import static com.quantumresearch.mycel.infrastructure.util.PrivacyUtils.scrubOnion;
