...
import com.quantumresearch.mycel.infrastructure.api.Cancellable;
...
import com.quantumresearch.mycel.infrastructure.api.contact.event.PendingContactStateChangedEvent;
...
import com.quantumresearch.mycel.infrastructure.api.plugin.event.TransportActiveEvent;
...
import com.quantumresearch.mycel.infrastructure.api.rendezvous.event.RendezvousConnectionClosedEvent;
import com.quantumresearch.mycel.infrastructure.api.rendezvous.event.RendezvousConnectionOpenedEvent;
import com.quantumresearch.mycel.infrastructure.api.rendezvous.event.RendezvousPollEvent;
...
import static com.quantumresearch.mycel.infrastructure.api.contact.PendingContactState.ADDING_CONTACT;
import static com.quantumresearch.mycel.infrastructure.api.contact.PendingContactState.FAILED;
import static com.quantumresearch.mycel.infrastructure.api.contact.PendingContactState.OFFLINE;
import static com.quantumresearch.mycel.infrastructure.api.contact.PendingContactState.WAITING_FOR_CONNECTION;
import static com.quantumresearch.mycel.infrastructure.rendezvous.RendezvousConstants.POLLING_INTERVAL_MS;
import static com.quantumresearch.mycel.infrastructure.rendezvous.RendezvousConstants.RENDEZVOUS_TIMEOUT_MS;
import static com.quantumresearch.mycel.infrastructure.test.CollectionMatcher.collectionOf;
import static com.quantumresearch.mycel.infrastructure.test.PairMatcher.pairOf;
...
import static com.quantumresearch.mycel.infrastructure.test.TestUtils.getTransportProperties;
