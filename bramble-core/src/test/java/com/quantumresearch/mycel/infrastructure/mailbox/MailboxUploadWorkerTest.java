...
import com.quantumresearch.mycel.infrastructure.api.plugin.event.ContactConnectedEvent;
import com.quantumresearch.mycel.infrastructure.api.plugin.event.ContactDisconnectedEvent;
...
import com.quantumresearch.mycel.infrastructure.test.ConsumeArgumentAction;
...
import static com.quantumresearch.mycel.infrastructure.mailbox.MailboxUploadWorker.CHECK_DELAY_MS;
import static com.quantumresearch.mycel.infrastructure.mailbox.MailboxUploadWorker.RETRY_DELAY_MS;
