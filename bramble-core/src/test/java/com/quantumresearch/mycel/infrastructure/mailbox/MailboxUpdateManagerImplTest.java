...
import com.quantumresearch.mycel.infrastructure.api.mailbox.event.MailboxPairedEvent;
import com.quantumresearch.mycel.infrastructure.api.mailbox.event.MailboxUnpairedEvent;
import com.quantumresearch.mycel.infrastructure.api.mailbox.event.MailboxUpdateSentToNewContactEvent;
import com.quantumresearch.mycel.infrastructure.api.mailbox.event.RemoteMailboxUpdateEvent;
...
import static com.quantumresearch.mycel.infrastructure.api.mailbox.MailboxUpdateManager.CLIENT_ID;
import static com.quantumresearch.mycel.infrastructure.api.mailbox.MailboxUpdateManager.GROUP_KEY_SENT_CLIENT_SUPPORTS;
import static com.quantumresearch.mycel.infrastructure.api.mailbox.MailboxUpdateManager.GROUP_KEY_SENT_SERVER_SUPPORTS;
import static com.quantumresearch.mycel.infrastructure.api.mailbox.MailboxUpdateManager.MAJOR_VERSION;
...
import static com.quantumresearch.mycel.infrastructure.api.mailbox.MailboxUpdateManager.PROP_KEY_AUTHTOKEN;
import static com.quantumresearch.mycel.infrastructure.api.mailbox.MailboxUpdateManager.PROP_KEY_INBOXID;
import static com.quantumresearch.mycel.infrastructure.api.mailbox.MailboxUpdateManager.PROP_KEY_ONION;
import static com.quantumresearch.mycel.infrastructure.api.mailbox.MailboxUpdateManager.PROP_KEY_OUTBOXID;
...
import static com.quantumresearch.mycel.infrastructure.test.TestUtils.getEvent;
...
import static com.quantumresearch.mycel.infrastructure.test.TestUtils.hasEvent;
import static com.quantumresearch.mycel.infrastructure.test.TestUtils.mailboxUpdateEqual;
