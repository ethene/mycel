...
import com.quantumresearch.mycel.spore.mailbox.MailboxApi.MailboxContact;
...
import static com.quantumresearch.mycel.spore.test.TestUtils.readBytes;
import static com.quantumresearch.mycel.spore.test.TestUtils.writeBytes;
