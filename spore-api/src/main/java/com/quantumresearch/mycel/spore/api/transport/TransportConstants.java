...
public interface TransportConstants {
	...
	String STATIC_MASTER_KEY_LABEL =
			"com.quantumresearch.mycel.spore.transport/STATIC_MASTER_KEY";
	...
	String PENDING_CONTACT_ROOT_KEY_LABEL =
			"com.quantumresearch.mycel.spore.transport/PENDING_CONTACT_ROOT_KEY";
	...
	String CONTACT_ROOT_KEY_LABEL =
			"com.quantumresearch.mycel.spore.transport/CONTACT_ROOT_KEY";

	/**
	 * Label for deriving Alice's initial tag key from the root key in
	 * rotation mode.
	 */
	String ALICE_TAG_LABEL = "com.quantumresearch.mycel.spore.transport/ALICE_TAG_KEY";

	/**
	 * Label for deriving Bob's initial tag key from the root key in rotation
	 * mode.
	 */
	String BOB_TAG_LABEL = "com.quantumresearch.mycel.spore.transport/BOB_TAG_KEY";
	...
	String ALICE_HEADER_LABEL =
			"com.quantumresearch.mycel.spore.transport/ALICE_HEADER_KEY";
	...
	String ALICE_HANDSHAKE_HEADER_LABEL =
			"com.quantumresearch.mycel.spore.transport/ALICE_HANDSHAKE_HEADER_KEY";

	/**
	 * Label for deriving Bob's header key from the root key in handshake mode.
	 */
	String BOB_HANDSHAKE_HEADER_LABEL =
			"com.quantumresearch.mycel.spore.transport/BOB_HANDSHAKE_HEADER_KEY";
}
