...
public interface KeyAgreementCrypto {
	 ...
	 */
	String COMMIT_LABEL = "com.quantumresearch.mycel.spore.keyagreement/COMMIT";

	/**
	 * Key derivation label for confirmation record.
	 */
	String CONFIRMATION_KEY_LABEL =
			"com.quantumresearch.mycel.spore.keyagreement/CONFIRMATION_KEY";

	/**
	 * MAC label for confirmation record.
	 */
	String CONFIRMATION_MAC_LABEL =
			"com.quantumresearch.mycel.spore.keyagreement/CONFIRMATION_MAC";
